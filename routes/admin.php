...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::prefix('home-page')->group(function () {
        ...
        //Promo banner
        Route::get('/promo-banner', [PromobannerController::class, 'index'])->name('promobanner.index');
        Route::post('/promo-banner/store', [PromobannerController::class, 'store'])->name('promobanner.store');
