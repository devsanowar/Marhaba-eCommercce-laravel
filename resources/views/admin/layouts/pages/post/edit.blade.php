        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mt-3">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-uppercase"> Edit Post <span><a href="{{ route('post.index') }}" class="btn btn-primary right">All Posts</a></span></h4>

                </div>
                <div class="body">
                    <form class="form-horizontal" action="{{ route('post.update',$post->id) }}"
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-8 col-xs-7 mb-3">
                            ...
                            <div class="form-group">
                                <div class="" style="border: 1px solid #ccc">
                                    <input type="text" id="post_title_id" name="post_title" class="form-control @error('service_title')invalid @enderror"
                            ...
                            <div class="form-group">
                                <div class="" style="border: 1px solid #ccc">
                                    <select name="is_active" class="form-control show-tick">
                                        <option @if($post->is_active == 1 ) selected @endif value="1">Active</option>
                                        <option @if($post->is_active == 0 ) selected @endif value="0">DeActive</option>
                                    </select>
                                </div>
                            </div>
                        </div>
